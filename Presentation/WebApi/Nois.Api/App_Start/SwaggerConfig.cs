...
namespace Nois.Api
{
    public class SwaggerConfig
    {
        public static void Register()
        {
            ...
            GlobalConfiguration.Configuration
                .EnableSwagger(c =>
                {
                    ...
                    //
                    c.SingleApiVersion("v1", "Api for Nois Solution");
                ...
                .EnableSwaggerUi(c =>
                {
                    ...
                    //c.InjectJavaScript(thisAssembly, "Nois.Api.SwaggerXml.SwaggerUIEnableBearerToken.js");
        ...
        {
            return System.String.Format(@"{0}\bin\Nois.Api.XML", System.AppDomain.CurrentDomain.BaseDirectory);
        }
        /// <summary>
        /// 
        /// </summary>
